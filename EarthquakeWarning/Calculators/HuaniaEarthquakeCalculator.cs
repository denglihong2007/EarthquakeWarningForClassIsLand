...
public static class HuaniaEarthQuakeCalculator
{
    private const double EARTH_RADIUS = 6378.137d;

    private static readonly double[] SLOPE =
        [0.23335281, 0.23347212, 0.23335606, 0.23335613, 0.23335539, 0.23335367, 0.23335291f];

    private static readonly double[] INTERCEPT =
    ...
    public static double GetDistance(double latitude1, double longitude1, double latitude2, double longitude2)
    {
        ...
        */
        var firstRadLat = Math.PI / 180 * latitude1;
        var firstRadLng = Math.PI / 180 * longitude1;
        var secondRadLat = Math.PI / 180 * latitude2;
        var secondRadLng = Math.PI / 180 * longitude2;
